			...
			<div style="text-align: center">
				...
				<form id="add_from" action="emp.do?method=save" method="post"
					...
					<div class="form-group">
						<label class="exampleInputName">姓名</label> <input id="name"
							value="" style="height: 30px" name="name" type="text"
							required="required" placeholder="请输入姓名"> <span
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<a href="emp.do?method=findAll"> <input
								class="btn btn-primary" type="button" class="button" value="返回" />
							</a>
						</div>
				</form>
